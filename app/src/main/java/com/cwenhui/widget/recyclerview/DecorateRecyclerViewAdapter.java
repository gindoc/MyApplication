package com.cwenhui.widget.recyclerview;
 ...
 */
public class DecorateRecyclerViewAdapter<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public DecorateRecyclerViewAdapter(T base) {
        super();
        mBase = base;
    }
